...
import 'package:ssip/tele pages/datatele.dart';
    ...
    return Container(
      decoration: const BoxDecoration(
        image: DecorationImage(
          image: AssetImage('assets/images/bgtele.jpg'),
          fit: BoxFit.cover,
        ),
      ),
      child: Scaffold(
    ...
    return AlertDialog(
      ...
      content: Column(
        ...
        children: <Widget>[
          const Text(
            '''
Using this app may involve certain risks and can lead to actions taken by Telegram, including the suspension or banning of your account. Please proceed with caution and ensure that you comply with telegram's terms of service and community guidelines.
...
class _UsernamePasswordState extends State<UsernamePassword> {
  ...
  Future<void> login(BuildContext context) async {
    ...
    final response = await http.post(
      Uri.parse('http://192.168.1.6:5100/tel-login'),
      headers: <String, String>{
        'Content-Type': 'application/json; charset=UTF-8',
      },
      body: jsonEncode(
        <String, String>{'channel_link': usernameval},
      ),
    );
    ...
    if (response.statusCode == 200) {
      ...
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => DataScreen1()),
      );
    } else {
      setState(() {
              ...
              children: [
                TextField(
                  ...
                  decoration: const InputDecoration(
                    ...
                    hintText: 'Enter your channel_name',
                  ),
                ),
                const SizedBox(height: 20),
